...
//顶部特效
 window.onscroll=function up(){
  ...
  //手机循环跳动
   /*$(".case-sub-content-box").css("display","block");
  var caseapp=document.getElementsByClassName("case-app")
  	$(".case-sub-content-text").css("display","none");
  $(".case-sub-content-text").eq(0).css("display","block");
  for( var i=0; i<caseapp.length;i++){
  document.getElementsByClassName("case-app")[i].onmouseover=function(){
  	this.className="case-app animated bounce";
  	this.style.marginTop="70px";
  	this.style.transitionDelay="0s";
    $(".case-sub-content-text").css("display","none");
  	$(".case-sub-content-text").eq($(this).index()).css("display","block");
  	$(".case-sub-content-text").eq($(this).index()).addClass("case-sub-content-text animated bounceInLeft")
  };
  document.getElementsByClassName("case-app")[i].onmouseleave=function(){
  	this.className="case-app";
	...
	//$(".case-sub-content-text").css("display","none");
  	    //$(".case-sub-content-text").eq(0).css("display","block");
  	    //$(".case-sub-content-text").eq(3).css("display","block");
  	    //$(".case-sub-content-text").eq(6).css("display","block");
